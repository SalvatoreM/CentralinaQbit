...
<pre><p>
<table border="3" bgcolor='#f0f0f0' cellpadding = "5" align = "center" width = "500">
<tr>
<td>
<?php
...
$provincia_option=array("Firenze","Prato");
/*----------------------------------------------------------------------------*/
/*----------------------------------------------------------------------------*/
...
$checked="";
if  (in_array("salvatorehost.no-ip.org,InfluxDB",$lista["host"])){$checked="checked";}
echo '<th align="left"><input type="checkbox" name="host[]" value="salvatorehost.no-ip.org,InfluxDB" '.$checked.'/>Server Ninux<br>';
$checked="";
if  (in_array("92.223.147.77/nodered,CrateDB",$lista["host"])){$checked="checked";}
echo '<input type="checkbox" name="host[]" value="92.223.147.77/nodered,CrateDB" '.$checked.'/>Server MnI<br></th></tr>';
/*----------------------------------------------Dati ------------------------------*/
echo '<tr><th>Nome(Zona::IDName)</th><th><input type="text" pattern="[a-zA-Z0-9]+::[a-zA-Z0-9]+" name="nome" value="'.$lista["nome"].'"/></th></tr>';
echo "</th></tr>";
echo '<tr><th>User</th><th><input type="text" pattern="[a-zA-Z0-9]+" name="user" value="'.$lista["user"].'"/></th></tr>';
echo '<tr><th>Codice ID (una o due cifre)</th><th><input type="text" pattern="[0-9]{1,2}" name="id" value="'.$lista["id"].'"/></th></tr>';
...
echo '<tr><th>Correzione PM10</th><th><input type="text" style="text-align: center;" pattern="[+-]?[0-9]+.[0-9]+" size="4" name="k1" value="'.$lista["k1"].'" readonly/>* Y +';
echo '<input type="text" style="text-align: center;" pattern="[+-]?[0-9]+.[0-9]+" size="4" name="q1" value="'.$lista["q1"].'" readonly/></th></tr>';
echo '<tr><th>Correzione PM2.5</th><th><input type="text" style="text-align: center;" pattern="[+-]?[0-9]+.[0-9]+" size="4" name="k2" value="'.$lista["k2"].'" readonly/>* Y +';
...
echo '<input type="radio" name="sensore" value="Alfetta" '.$checked.'  >OPC-N2 Alphasense<br>';
$checked="";
if  ($lista["sensore"]=="QBIT"){$checked="checked";}
echo '<input type="radio" name="sensore" value="QBIT" '.$checked.' >Qbit<br></th></tr>';
echo "</table><br>";
/*------------------------------Save----------------------------------------------*/
...
echo '<tr><th>Responsabile</th><th><input type="text" pattern="[a-zA-Z0-9 ]+" name="responsabile" value="'.$lista["responsabile"].'"/></th></tr>';
